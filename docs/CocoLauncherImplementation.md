...
Simple Voice Chat usa UDP 24454, separado del TCP de Minecraft. El manifiesto de red publica `Coco Voice - ZeroTier UDP 24454`; el helper elevado la limita a entrada UDP, perfil Private y `10.77.37.0/24`. En clientes se elimina cualquier regla de entrada Coco equivalente.
