...
| Machine Party | Standalone Executable | Visible | Juego party multijugador en Godot 4. Workflow `coco-standalone` para descarga de ZIP verificado por SHA-256 y ejecucion directa sin Java/PortableMC. |
