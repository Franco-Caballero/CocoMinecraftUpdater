...
# Fetch release v0.5.84
req = urllib.request.Request("https://api.github.com/repos/Franco-Caballero/CocoMinecraftUpdater/releases/tags/v0.5.84", headers=headers)
with urllib.request.urlopen(req) as resp:
    rel = json.loads(resp.read().decode('utf-8'))

print(f"Found v0.5.84 release ID: {rel['id']}")
...
with urllib.request.urlopen(patch_req) as p_resp:
    ...
    print(f"SUCCESS: Release v0.5.84 is now set as LATEST! URL: {res_obj.get('html_url')}")
