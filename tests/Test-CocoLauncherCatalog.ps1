...
if(-not$peakMods-or[int64]$peakMods.size-ne2536101-or[string]$peakMods.sha256-ne'18058abb357d1e4ca772027b8528c6c83098fce69906c07b35309ab2d9e98b8a'-or[string]$peakMods.role-ne'all'){
